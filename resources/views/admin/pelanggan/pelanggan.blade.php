...
@section('main')
                ...
                <tr class="transition duration-150 hover:bg-gray-50">
                  ...
                  <td class="whitespace-nowrap px-6 py-4 text-sm font-medium">
                    <div class="flex space-x-3">
                      <button onclick="editPelanggan(this)" data-id="{{ $p->id }}"
                        data-id_tarif="{{ $p->id_tarif }}" data-nomor_kwh="{{ $p->nomor_kwh }}"
                        data-nama_pelanggan="{{ $p->nama_pelanggan }}" data-alamat="{{ $p->alamat }}"
                      ...
                      <form action="{{ route('pelanggan.destroy', $p->id) }}" method="POST" class="flex"
  ...
  <!-- Edit Modal -->
  <div id="editModal" class="fixed inset-0 z-50 hidden h-full w-full overflow-y-auto bg-gray-600/40">
    <div class="flex min-h-screen items-center justify-center">
      <div class="relative mx-auto max-w-md w-full rounded-lg border bg-white p-5 shadow-xl">
        <div class="mt-3">
          ...
          <form id="editPelangganForm" method="POST">
            ...
            <div class="mb-4">
              <label for="edit_nama_pelanggan" class="mb-2 block text-sm font-medium text-gray-700">Nama
                Pelanggan</label>
